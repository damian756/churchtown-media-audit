...
export const metadata: Metadata = {
  ...
  description: 'Get expert answers to 200+ questions about Next.js web design, local SEO, WordPress migration, pricing, and digital marketing in Southport and Blackpool.',
  alternates: {
