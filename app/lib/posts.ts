  ...
  export const posts: BlogPost[] = [
    {
      ...
      content: `
        ...
        <p>As we discussed in our <a target="_blank" href="/blog/mlec-effect-southport">Southport Business Growth</a> pillar, the town is changing. The visitors coming for conferences and events at the MLEC won&#8217;t have &#8220;local knowledge.&#8221; They won&#8217;t know that the best sandwich shop is hidden down a side street off Lord Street.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <p>At <strong>Churchtown Media</strong>, we call this the &#8220;Digital Tourist&#8221; phenomenon. Here is how to ensure that when MLEC delegates search for &#8220;dinner near me,&#8221; your business is the first one they see.</p>
        ...
        <p>Transforming your digital presence to meet this demand costs money, but you might not have to pay for all of it yourself. As we detailed in our <strong><a target="_blank" href="/blog">Southport Business Growth Hub</a></strong>, there are active grants available right now—like the <strong>InvestSefton Growth Hub</strong> support—that can help fund digital consultancy and technical upgrades.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <p><a href="/services/seo" style="background-color:#198754; color:white; padding:10px 20px; text-decoration:none; border-radius:5px;"><strong>Book a Free &#8220;No-Nonsense&#8221; Audit</strong></a></p>
      `
    },
    {
      ...
      content: `
        ...
        <h3>The &#8220;Default&#8221; Trap</h3>
        <p>If you are a local business owner—say, a plumber in Birkdale or a solicitor in town—and you try to set up Google Ads yourself, Google makes it incredibly easy. Too easy.</p>
