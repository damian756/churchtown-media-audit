...
const jsonLd = {
  ...
  '@type': 'Service',
  name: 'Web Design & SEO for Golf Clubs',
  description: 'Churchtown Media builds websites and SEO strategies for golf clubs on the Lancashire coast, including Southport and Blackpool.',
  provider: {
