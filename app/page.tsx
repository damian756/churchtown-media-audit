...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ══════════════════════════════════════════
          1. HERO — split layout, proof over claims
      ══════════════════════════════════════════ */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[520px] pb-16">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 mb-10">
                <Link href="/work" className="px-7 py-3.5 bg-white text-slate-900 font-bold rounded-xl hover:bg-slate-100 transition-all flex items-center gap-2 group">
