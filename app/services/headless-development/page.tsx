      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid gap-12 md:grid-cols-3">
            <div className="rounded-xl border border-slate-200 p-8 shadow-sm">
                ...
                <h3 className="mt-4 text-xl font-bold text-slate-900">Sub-100ms Loads</h3>
            ...
            <div className="rounded-xl border border-slate-200 p-8 shadow-sm">
                ...
                <h3 className="mt-4 text-xl font-bold text-slate-900">Un-Hackable</h3>
                <p className="mt-2 text-slate-600">
            ...
            <div className="rounded-xl border border-slate-200 p-8 shadow-sm">
                <LayoutTemplate className="h-10 w-10 text-purple-600" />
                <h3 className="mt-4 text-xl font-bold text-slate-900">Sanity CMS</h3>
                <p className="mt-2 text-slate-600">
        ...
        {/* CTA */}
        <div className="mt-16 rounded-3xl bg-slate-900 px-6 py-12 text-center">
            ...
            <div className="mt-8 flex justify-center gap-4">
                ...
                <Link href="/contact" className="rounded-lg border border-slate-700 px-6 py-3 font-bold text-white hover:bg-slate-800">
                    Discuss Migration
                </Link>
            </div>
        </div>
