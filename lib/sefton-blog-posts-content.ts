/**
 * SEFTON SURROUNDING AREAS BLOG POSTS - FULL CONTENT
 * These are complete, SEO-optimized blog posts for the 5 Sefton areas
 * Copy/paste the content field into posts.ts for each corresponding slug
 */

export const seftonBlogContent = {
  ...
  // Content for the other 4 posts continues...
  // (truncated for file size - will be added separately)
};
